...
const ParticleBackground = ({
  ...
  return (
    ...
    >
      <motion.div
        className="absolute inset-0 bg-gradient-to-b from-[#0f0418] via-[#1a0b2e] to-[#0f0418] opacity-80"
        style={{ opacity }}
        animate={controls}
      />
      ...
      <motion.div
        className="absolute top-2/3 left-1/2 w-72 h-72 rounded-full bg-fuchsia-600/10 blur-3xl"
        animate={{
          x: [0, 40, 0],
          y: [0, -20, 0],
          scale: [1, 1.15, 1],
